package com.nuvoton.otaserver.crccalc;
 ...
 */
    ...
    /// should be specified as a hexadecimal uint8.The top bit of the
    ...
    /// hexadecimal uint8.It is XORed to the final register value (after
